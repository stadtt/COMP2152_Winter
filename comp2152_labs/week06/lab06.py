...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Lab 06 - Question 5b
    functions_lab06.adjustment_combat_strength(combat_strength, m_combat_strength)
    ...
    while (num_dream_lvls < 0 or num_dream_lvls > 3):
        ...
        if (num_dream_lvls==""):
            num_dream_lvls = -1
            print("You should enter a whole number between 1-3. Try again.")
        else:
        ...
        print("The Dream level is: ", num_dream_lvls)
    # Fight Sequence
