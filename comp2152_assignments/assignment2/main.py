...
if not input_invalid:
    input_invalid = False
    combat_strength = int(hero.combat_strength)
    m_combat_strength = int(monster.combat_strength)
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    hero.combat_strength = min(6, (int(hero.combat_strength) + int(weapon_roll)))
    ...
    monster.combat_strength = int(monster.combat_strength) + int(min(6, (int(monster.combat_strength) + int(monster_powers[power_roll]))))
